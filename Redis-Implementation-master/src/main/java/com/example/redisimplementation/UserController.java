...
public class UserController {
    ...
    public User getValue(@RequestParam("key")String key){
        return (User)redisTemplate.opsForValue().get(key); //by default return ype is Object class
    }
    //////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////
    //it will take the key and converts the object as a map i.e attribute is key and the value is value
    @PostMapping("/hmset")
    public void addHashValue(@RequestParam("key")String key,@RequestBody()User user){
        Map map = objectMapper.convertValue(user,Map.class); //conversion
        redisTemplate.opsForHash().putAll(key,map);
    }

    @GetMapping("/hget")  //hashkey is the atrbute name
    ...
    public User getHashValueAll(@RequestParam("key")String key){
        ...
        User user = objectMapper.convertValue(map,User.class);   //objctMapper is for converting
        return user;
    }
}
